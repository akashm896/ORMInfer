 ...
 * Copyright (C) 2006-2008 Paul Sabatier University, IUP ISI (Toulouse, France) <massie@irit.fr>
 *
...
public class ConcreteTaskBean {
	...
	public String createNewTaskActionListener() {
		...
		if(this.newTaskName.equals(""))
		{
			...
			.addErrorMessage(LocaleBean
					.getText("component.tableparticipantProcessProject.taskNameMissing"));
		}
		else if(this.selectedConcreteActivityId.equals("default"))
		{
			WebCommonService
			.addErrorMessage(LocaleBean
					.getText("component.tableparticipantProcessProject.taskActivityMissing"));
		}
		else if (!this.selectedConcreteActivityId.equals("default")) {
		RoleDescriptor rd;
		...
		if (this.projectService
				.createTask(this.newTaskName, this.newTaskDescription,
						project, rd, cact, recurActivities)) {
			WebCommonService
					.addInfoMessage(LocaleBean
							.getText("component.tableparticipantProcessProject.taskCreated"));
		} else {
			WebCommonService
					.addErrorMessage(LocaleBean
							.getText("component.tableparticipantProcessProject.taskNotCreated"));
		}
	...
	public void changeRolesListener(ValueChangeEvent evt) {
		...
		this.addTaskRendered = !(this.selectedRoleDescriptorId
				.equals("default"))
	...
	public List<SelectItem> getRoles() {
		...
		rolesList
				.add(new SelectItem(
						"default",
						LocaleBean
								.getText("component.tableparticipantProcessProject.concreteRolesComboBox")));
