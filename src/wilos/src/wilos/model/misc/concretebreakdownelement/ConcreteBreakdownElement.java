...
public class ConcreteBreakdownElement implements Cloneable,
		Comparable<ConcreteBreakdownElement>, Serializable {
	...
	/*
	 * The instanciation order of the concrete element.
	 */
	...
	public int compareTo(ConcreteBreakdownElement _arg0) {
		if (this.breakdownElement != null) {
			int compare = this.breakdownElement.compareTo(_arg0
					.getBreakdownElement());
			if (compare == 0) {
				return this.getInstanciationOrder()
						- _arg0.getInstanciationOrder();
			} else
				return compare;
		} else
			// TODO : check the instanciationOrder attribution algorithm
			// return 0;
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(this.concreteName,
				...
				this.instanciationOrder,
				concreteBreakdownElement.instanciationOrder).append(
				this.displayOrder, concreteBreakdownElement.displayOrder)
				.isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(17, 37).append(this.concreteName).append(
				this.breakdownElement).append(
				this.instanciationOrder).append(this.displayOrder).toHashCode();
	}
