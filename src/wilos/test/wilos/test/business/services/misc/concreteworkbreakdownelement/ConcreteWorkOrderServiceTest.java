...
public class ConcreteWorkOrderServiceTest {
	...
	this.cwbde1Id = this.concreteWorkBreakdownElementDao
		.saveOrUpdateConcreteWorkBreakdownElement(this.concreteWorkBreakdownElement1);

	this.cwbde2Id = this.concreteWorkBreakdownElementDao
		.saveOrUpdateConcreteWorkBreakdownElement(this.concreteWorkBreakdownElement2);

	/*ConcreteWorkOrderId concreteWorkOrderId = this.concreteWorkOrderService
		.saveConcreteWorkOrder(this.cwbde1Id, this.cwbde2Id,
			"startToFinish", "default");*/
	
	ConcreteWorkOrderId concreteWorkOrderId = this.concreteWorkOrderService
	.saveConcreteWorkOrder(this.cwbde1Id, this.cwbde2Id,
		"startToFinish", p.getId());

	ConcreteWorkBreakdownElement retrievedConcreteWorkBreakdownElement1 = this.concreteWorkBreakdownElementDao
		.getConcreteWorkBreakdownElement(this.cwbde1Id);
	assertNotNull("not null", retrievedConcreteWorkBreakdownElement1);

	Set<ConcreteWorkOrder> concreteWorkOrdersS = this.concreteWorkOrderService
		.getAllConcreteWorkOrdersFromConcreteWorkBreakdownElement(retrievedConcreteWorkBreakdownElement1);
	assertEquals("size of concreteWorkOrders", 1, concreteWorkOrdersS
		.size());
	assertEquals("size of concreteWorkOrders", 1,
		this.concreteWorkOrderService.getConcreteSuccessors(
			retrievedConcreteWorkBreakdownElement1).size());

	ConcreteWorkBreakdownElement retrievedConcreteWorkBreakdownElement2 = this.concreteWorkBreakdownElementDao
		.getConcreteWorkBreakdownElement(this.cwbde2Id);

	Set<ConcreteWorkOrder> concreteWorkOrdersP = this.concreteWorkOrderService
		.getAllConcreteWorkOrdersFromConcreteWorkBreakdownElement(retrievedConcreteWorkBreakdownElement2);
	assertEquals("size of concreteWorkOrders", 1, concreteWorkOrdersP
		.size());
	assertEquals("size of concreteWorkOrders", 1,
		this.concreteWorkOrderService.getConcretePredecessors(
			retrievedConcreteWorkBreakdownElement2).size());

	ConcreteWorkOrder concreteWorkOrder = this.concreteWorkOrderService
		.getConcreteWorkOrder(concreteWorkOrderId);
	this.concreteWorkOrderService
		.deleteConcreteWorkOrder(concreteWorkOrder);
