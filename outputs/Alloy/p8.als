...
fact { u_____NotEq_____NotEq_10 = ((u_Sel___ClassRef_com_r2 != none) => (((((((u_principal != NullNode) => (u_principalusername = u_Pi___Join_____Sel___5.u_username) else (0!=0))) => (u_1) else (u_0)) != u_0) => (u_Post_comments_Pi___J13) else (u___modelattribute__post_comments))) else (u___modelattribute__post_comments)) }
...
fact { u_____NotEq_____NotEq_32 = ((u_Sel___ClassRef_com_r2 != none) => (((((((u_principal != NullNode) => (u_principalusername = u_Pi___Join_____Sel___5.u_username) else (0!=0))) => (u_1) else (u_0)) != u_0) => (u_Post_user_Pi___Join_35) else (u___modelattribute__post_user))) else (u___modelattribute__post_user)) }
